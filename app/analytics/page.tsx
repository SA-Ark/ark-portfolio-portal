  ...
  return (
    <>
      <MotionSection className="space-y-4">
        ...
        <p className="max-w-3xl text-lg leading-8 text-zinc-400">Portfolio intelligence for revenue, retention, pipeline conversion, and team utilization using seeded chart data.</p>
      </MotionSection>
