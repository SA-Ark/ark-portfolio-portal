    ...
    <>
      <section className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
        ...
        <Card className="overflow-hidden">
          <CardHeader>
            <CardTitle className="flex items-center gap-2"><Sparkles className="h-6 w-6 text-blue-400" /> AI briefing</CardTitle>
      ...
      <section className="grid gap-8 xl:grid-cols-[1.4fr_0.6fr]">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {recentActivity.map((item) => <div key={item} className="rounded-2xl border border-zinc-800 bg-zinc-950 p-4 text-base leading-7 text-zinc-300">{item}</div>)}
          </CardContent>
        </Card>
      </section>
